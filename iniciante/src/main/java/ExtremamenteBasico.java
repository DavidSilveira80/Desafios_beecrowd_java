...
public class ExtremamenteBasico {
    public static int soma_A_B(int A, int B ){
        return A + B;
    }

    public static String soma_saida(int A, int B){
        return String.format("X = %d", soma_A_B(A, B));
    }
    ...
    public static void main(String[] args){
        ...
        System.out.println(soma_saida(A, B));
